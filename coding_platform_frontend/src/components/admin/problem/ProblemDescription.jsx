...
import { BookOpen, Code, History, CheckCircle, XCircle, AlertTriangle } from "lucide-react"
import { Progress } from "@/components/ui/progress.jsx"

// Add a new TestCaseResults component
function TestCaseResults({ result }) {
    if (!result) return null

    const { passedTestCases, totalTestCases, status } = result
    const progressValue = totalTestCases > 0 ? (passedTestCases / totalTestCases) * 100 : 0
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
                ...
                <CardContent className="p-0 rounded-b-lg">
                    <TabsContent value="description" className="m-0 h-full flex flex-col">
                        ...
                        {/* Add the TestCaseResults component */}
                        {result && (
